...
class GeneratorOption {
  ...
  public boolean equals(Object obj) {
    return obj instanceof GeneratorOption && ((GeneratorOption)obj).getFieldName().equals(getFieldName());
  }
  ...
  public String getFieldName() {
    return toFieldName(owner == null ? tag : getSimpleName());
  }
  ...
  public String getTagName() {
    String simple = getSimpleName().replace("ArgHandler", "");
    return simple.contains("gwtc") ? simple : "gwtc-"+toTagName(simple).replace("-argument", "");
  }
  ...
  public String getFactoryName() {
    String string = getSimpleName().replace("ArgHandler", "");
