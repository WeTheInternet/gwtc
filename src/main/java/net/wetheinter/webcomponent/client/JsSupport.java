...
public class JsSupport {
  ...
  public static native JsArrayOfString unboxArrayOfString(JavaScriptObject o, String joiner)
  /*-{
    if (!o) {
      return [];
    }
  ...
  public static native JsArrayOfInt unboxArrayOfInt(JavaScriptObject o, String joiner)
  /*-{
    if (!o) {
      return [];
    }
  ...
  public static native JsArrayOfNumber unboxArrayOfNumber(JavaScriptObject o, String joiner)
  /*-{
    if (!o) {
      return [];
    }
  ...
  public static native JsArrayOfBoolean unboxArrayOfBoolean(JavaScriptObject o, String joiner)
  /*-{
    if (!o) {
      return [];
    }
  ...
  public static native PolymerElement setPolymerAttr(PolymerElement group, String string)
  /*-{
    group.setAttribute(string, "");
    return group;
  }-*/;
  ...
  /*-{
    ...
    if (i) {
      ...
      return @net.wetheinter.webcomponent.client.JsSupport::unboxDouble(Lcom/google/gwt/core/client/JavaScriptObject;)(i);
    }
    return 0;
  }-*/;
  ...
  /*-{
    ...
    if (i) {
      ...
      return @net.wetheinter.webcomponent.client.JsSupport::unboxBoolean(Lcom/google/gwt/core/client/JavaScriptObject;)(i);
    }
    return false;
  }-*/;
